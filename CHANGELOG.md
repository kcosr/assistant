...
- Removed the orphaned coding executor and sidecar workspaces, their obsolete documentation and build wiring, and the unused Notes diff preview. ([#133](https://github.com/kcosr/assistant/pull/133))
