...
- Changed list item review mode inline edits to replace previews with inline editors, allow canceling text edits, use shared markdown rendering with collapsible sections, render markdown custom fields full-width, and reduce preview re-rendering while editing; renamed Quick edit to Edit. ([#38](https://github.com/kcosr/assistant/pull/38))
