...
- Added a rolling Android-native voice event log, retrievable over `adb`, covering state transitions, voice actions, TTS/STT handoff, and recognition submission breadcrumbs.
