...
- Added Realtime-specific persistent notification controls (Mute/Unmute and End call) that replace Thread speak/mode/media-button actions while a duplex call is live.
