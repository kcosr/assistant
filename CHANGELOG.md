...
- Add scheduled sessions for cron-driven agent runs with plugin UI, API, and configurable auto titles.
...
- Fixed sessions panel rendering when mounted as a standard panel in web/Tauri layouts.
### Removed
