...
- Added focus history to target the most recently used panel type (Ctrl+T for time tracker, persisted locally). ([#000](https://github.com/kcosr/assistant/pull/000))
