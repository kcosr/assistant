...
export function buildSystemPrompt(
  ...
  if (hasToolContext) {
    const messageContextLines: string[] = [
      ...
      'If no context line is available (headless agents), call panels_list, panels_selected, or panels_tree (includeContext true) to find the target panel and its context.',
