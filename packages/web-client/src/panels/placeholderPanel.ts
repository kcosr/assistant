...
import type { PanelFactory, PanelHandle, PanelHost } from '../controllers/panelRegistry';
...
export function createPlaceholderPanel(
  ...
  return () => ({
    mount(container: HTMLElement, host: PanelHost): PanelHandle {
      container.innerHTML = '';
      ...
      header.innerHTML = `
        <div class="panel-header-main">
          <span class="panel-header-label" data-role="chrome-title"></span>
        </div>
